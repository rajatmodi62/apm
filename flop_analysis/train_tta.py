...
h,w = 32,32
d = 1024 
n_iters_tta = 1200 #number of iterations for test time adaptation for each sample
n_samples_fwd = 4
patch_size = 14
fwd_chunk_size = 512
batch_size = 32*2
...
def dump_island(orig_feat_out, i, iter,orig_img):
...
for i in range(idx, len(dataset)):
    ...
    for iter in range(n_iters_tta):
        ...
        if iter%50==0:
            ...
            dump_island(orig_feat_out, i, iter,orig_img)
